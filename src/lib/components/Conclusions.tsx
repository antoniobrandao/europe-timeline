...
const mainTitle = 'text-white text-[22px] border-b border-white/30 mb-5 mt-10 pb-2'
const subTitle = 'text-white text-[13px] mb-1 mt-10 uppercase'
const text = 'text-white/50 text-[13px]'
    ...
    <div>
      <div className="p-8">
        ...
        <div className="grid grid-cols-2 gap-8">
          <p className={text}>
            Europe went into a period of darkness when the School of Athens was closed and the
            profession of philosopher was banned by the Christian Church, because the Philosophers
            were associated with Paganism, and around the time of Justinian I (530), a doctrine of
            Christian religious orthodoxy had been fully consolidated.
          </p>
          <p className={text}>
            The religion fanaticism caused by the Christian model of propaganda installed and a
            climate of fear and terror "for heresy or demon worship" - which could apply to
            literally anything not sanctioned by the church. Under Christian influence, monks
            resorted to burning any books of philosophy they could find, considering them "works of
            demons" and the common folk, not knowing any better, became suspicious of the
            intellectual pursuits of philosophers.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <p className={text}>
            The Islamic Golden Age happened because Islamic leaders were initially not religious
            ...
            During some time, they even made this learning mandatory. This openness to knowledge
            lasted until Al-Mutawakkil denouced the study of philosophy, and lingered until Al-Qadir
            finally prohibited it, in favour of the literal interpretation of the Koran - which in
            turn brought about their own Dark Ages, which last until today (2024).
          </p>
        </div>
        <p className={mainTitle}>The Revival</p>
        <p className="text-white text-[13px] mb-1 uppercase">Looking back to the past</p>
        <div className="grid grid-cols-2 gap-8">
          <p className="text-white/50 text-[13px]">
            Europe came out of a period of darkness thanks to the work of intellectuals who looked
            back at the work of the pagan philosophers. Here the Christian scholar Bernard of
            Chartres coined the now famous phrase "standing on the shoulders of giants", talking of
            himself: "We are like dwarves perched on the shoulders of giants [the Ancients], and
          ...
          <p className="text-white/50 text-[13px]">
            ...
            clear that the intellectuals were "opening up" to philosophy again - was reading back
            Plato, Aristotle, and the writings of the Neoplatonic philosophers. The only difference
            was the Italian Renaissance, were an additional emphasis was placed in the revival of
            the art styles of the Greco-Roman, Hellenistic tradition.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <p className={text}>
            ...
            ancients, and bringing them back to Europe.
          </p>
          <p className={text}>
            Another irony is how the Islamic Golden Age was intrumental in the intellectual revival
            of Europe - because their translations (and the subsequent work they did upon it) ended
            up finding their way back to Europe - reawakening the long lost knowledge of the old
            pagan philosophers, re-invigorated by the constribution of the Islamic scholars
            themselves.
          </p>
          <p className="text-white/50 text-[13px]">
            Another reason why the Islamic Golden Age is important, is that European leaders
            obviously didn't fail to notice it, and the rapid development it facilitated to their
            civilisation. During the time of the Islamic Golden Age, Europe was fractured, split
            into several petty Kingdoms while the prosperous Caliphate was a massive expanding
            Empire which eventually came knocking at their door, conquering all the way through the
            Iberian Peninsula, and eventually reaching France - all this while their capital was all
            the way back in Baghdad!
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-8">
          <p className="text-white/50 text-[13px]">
            ...
            ironically, the Fall of Constantinople - the capital and last-standing city of the Roman
            Empire (they called themselves Romans, not Byzantines).
          </p>
          <p className="text-white/50 text-[13px]">
            ...
            knowledge but many surviving texts of the pagan philosophers, as well as many art
        ...
        <div className="grid grid-cols-2 gap-8">
          <p className="text-white/50 text-[13px]">
            ...
            the huge powers that Venice and Genoa had become, Italy was experiencing a major
          ...
          <p className="text-white/50 text-[13px]">
            ...
            class for real development, and all the good that came from economic prosperity.
            Therefore in this period the Church largely conceded to the Merchants, and lowered their
            religious grip. After all, it was now evident that some agents of the Merchant class
            (like the Medici) held more real power than the pope.
          </p>
        </div>

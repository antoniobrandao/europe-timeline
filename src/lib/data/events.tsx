...
export const notableSpanEvents: EventSpanType[] = [
  ...
  //   start: 314,
  //   end: 988,
  //   link: 'https://rassias.gr/9011.html',
  //   description: [
  //     `The following list of events is a complilation by the Greek author Vlassis Rassias. The original books are in Greek and I cannot provide links to sources proving these claims. The link to his page is below.`,
  //     `Therefore you may take them all as hypothetical. I will provide authoritative sources as I find them, and then update this content. If you are Greek or can read Greek, feel free to help out.`,
  //     `-`,
